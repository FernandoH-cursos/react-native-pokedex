...
import type {Move, Pokemon} from '../../domain/entities/pokemon';
import type {PokeApiPokemon} from '../interfaces/poke-api.interface';
...
export class PokemonMapper {
  static async pokeApiPokemonToEntity(data: PokeApiPokemon): Promise<Pokemon> {
    ...
    const moves = PokemonMapper.getMoves(data);

    //* Obtiene el color de fondo del avatar del pokemon
